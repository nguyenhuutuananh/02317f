...
class Migration_Version_101 extends CI_Migration
{
    ...
    public function up()
    {
        ...
        // Paypal
        add_option('paymentmethod_paypal_label', 'PayPal');
        add_option('paymentmethod_paypal_active', 0);
        add_option('paymentmethod_paypal_test_mode_enabled', 1);
        add_option('paymentmethod_paypal_username');
        add_option('paymentmethod_paypal_password');
        add_option('paymentmethod_paypal_signature');
        add_option('paymentmethod_paypal_currencies');

        // Stripe
        add_option('paymentmethod_stripe_label');
        add_option('paymentmethod_stripe_active',0);
        add_option('paymentmethod_stripe_test_mode_enabled',1);
        add_option('paymentmethod_stripe_api_secret_key');
        add_option('paymentmethod_stripe_api_publishable_key');
        add_option('paymentmethod_stripe_currencies');
