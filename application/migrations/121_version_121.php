...
class Migration_Version_121 extends CI_Migration
{
    ...
    public function up()
    {
        ...
        $content = "THIS FOLDER IS DEPRECED AND IS NOT USED ANYMORE. IF YOU DONT HAVE ANY CUSTOM WORK YOU CAN DELETE THIS FOLDER.";
        ...
        update_option('update_info_message', '<div class="col-md-12">
            <div class="alert alert-success bold">
                ...
                <p>
                    This window will reload automaticaly in 8 seconds and will try to clear your browser cache, however its recomended to clear your browser cache manualy.
                </p>
            </div>
        </div>
        <script>
