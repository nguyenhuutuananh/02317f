...
class Migration_Version_122 extends CI_Migration
{
    ...
    public function up(){
        ...
        add_option('paymentmethod_two_checkout_label', '2Checkout');
        add_option('paymentmethod_two_checkout_active', 0);
        add_option('paymentmethod_two_checkout_test_mode_enabled', 1);
        add_option('paymentmethod_two_checkout_account_number');
        add_option('paymentmethod_two_checkout_private_key');
        add_option('paymentmethod_two_checkout_publishable_key');
        add_option('paymentmethod_two_checkout_currencies','USD,EUR');
