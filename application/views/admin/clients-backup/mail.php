                    ...
                    <h1><a href="#" title="CRM">Email Marketing</a></h1>
                      <h2></h2>
                        ...
                        <div class="form-group">
                          ...
                          <input type="email" class="form-control" id="user_email" name="user_email" value="trantan.fososoft@gmail.com" placeholder="Nhập email của bạn..." required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <label for="to_email">Email người nhận:</label>
