...
<?php if(isset($client)){ ?>
<?php 
echo form_open_multipart(admin_url('clients/upload_attachment/'.$client->userid),array('class'=>'dropzone','id'=>'client-attachments-upload')); ?>
    <div class="dropdown" >
     <select name="one"  class="dropdown-select" style="height: 28px;
    position: relative;
        ...
        <table class="table dt-table" data-order-col="2" data-order-type="desc">
            ...
            <tbody>
                <?php foreach($attachments as $type => $attachment){
                    ...
                    <td><?php echo ($_att['name_category']); ?></td>
                    <td>
