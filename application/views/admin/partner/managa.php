                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="_buttons">
                                    <a class="btn btn-info mright5 test pull-left display-block" data-toggle="modal" data-target="#add_data" onclick="clear_data()" >Thêm môi giới</a>
                                    <a class="btn btn-default mright5 test pull-left display-block" data-toggle="modal" data-target="#import_data">import môi giới</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th>Công ty</th>
                            <th>Ngày thêm</th>
                            <th>loại môi giới(1= chuyên dự án,0= không hợp tác)</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-md-12">
                    ...
                    <?php echo render_select('status',array(array('id'=>1,'name'=>'Chuyên dự án'),array('id'=>'2','name'=>'Không hợp tác'), array('id'=>'3', 'name'=>'Giao dịch thành công')),array('id','name'),'Loại môi giới',''); ?>
...
<script>
    initDataTable('.table-partner_project','<?=admin_url()?>partner/init_relation_partner_project/<?=$type?>' , [0,7], [0,7]);
    function clear_data()
    {
