...
//                    });
    ...
    <input type="text" name="hourly_rate" value="<?php if (isset($member)) {
                                                    echo number_format($member->hourly_rate, 0, ",", ".");
                                                  }
                                                  else {
                                                    echo 0;
                                                  } ?>" id="hourly_rate" onkeyup="formart_money_contract('hourly_rate')" class="form-control">
...
//                   }
                    ...
                    foreach ($permissions as $permission) {
                     ...
                     <td class="text-center">
                      ...
                      else if ($permission['shortname'] == 'customers') {
...
<script>
  $(document).ready(function() {
    initDataTable('.table-staff-projects-bds', admin_url + 'staff/get_bds/<?=$member->staffid?>', [], []);
    initDataTable('.table-staff-clients', admin_url + 'staff/get_clients/<?=$member->staffid?>', [], []);
  });
