                ...
                <div class="panel_s">
                    ...
                    <div class="_buttons">
                            <?php if (has_permission('customers','','create')) { ?>
                                <a href="<?php echo admin_url('clients_simple/import'); ?>" class="btn btn-info pull-left display-block mright5">
                                    ...
                                    <hr />
                                        <div class="row mbot15">
                                            ...
                                            <div class="col-md-3 col-xs-6 border-right">
                                                <h3 class="bold"><?php echo total_rows('tblclients_simple',($where_summary != '' ? substr($where_summary,5) : '')); ?></h3>
                                                <span class="text-dark"><?php echo _l('customers_summary_total'); ?></span>
                                            </div>
                                            <div class="col-md-3 col-xs-6 border-right">
                                                <h3 class="bold"><?php echo total_rows('tblclients_simple','type_client=1'.$where_summary); ?></h3>
                                                <span class="text-info">KHÁCH HÀNG ĐANG QUAN TÂM</span>
                                            </div>
                                            <div class="col-md-3 col-xs-6 border-right">
                                                <h3 class="bold"><?php echo total_rows('tblclients_simple','type_client=2'.$where_summary); ?></h3>
                                                <span class="text-success">KHÁCH HÀNG ĐÃ THUÊ/MUA</span>
                                            </div>
                                            <div class="col-md-3 col-xs-6 border-right">
                                                <h3 class="bold"><?php echo total_rows('tblclients_simple','type_client=3'.$where_summary); ?></h3>
...
<?php include_once(APPPATH . 'views/admin/clients_simple/manage_js.php');?>
<script>
...
$(document).on('click', '.btn-edit-client', function(e) {
    ...
    $.get(admin_url + '/clients_simple/modal_client/' + $(this).attr('data-userid'), function(data) {
...
$(document).on('click', '.btn-change-to-client', function(e) {
    let buttonNew = $(this).button('loading');
    $.get(admin_url + 'clients_simple/convert/' + buttonNew.attr('data-userid') , function(response) {
        if(data.success) {
