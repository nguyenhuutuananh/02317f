        ...
        <script>
            ...
            $( document ).ready(function() {
                ...
                $('#code,#province_name,#district_name,' +
                    ...
                    '#email,#furniture_name,#convenient,#characteristics,' +
                    ...
                    var list_input=['code','province_name','district_name','type_pn','door_direction_name',
                     'fullname','numberphone','email','furniture_name','convenient','characteristics','date_update',
                ...
                $('#province_name,#district_name,' +
                    '#door_direction_name,' +
                    '#furniture_name').on('change', function () {
