...
<div class="modal fade lead-modal" id="addPeriod" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
...
<div class="modal fade lead-modal" id="addPayment" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close btn-close-single-modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade lead-modal" id="viewPaymentList" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
