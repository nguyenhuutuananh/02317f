...
function init_relation_tasks_table($table_attributes = array())
{
    ...
    if ($table_attributes['data-new-rel-type'] == 'project') {
            ...
            echo '<a href="#" data-toggle="modal" data-target="#tasks_bulk_actions" class="btn btn-info mbot15">'._l('bulk_actions').'</a>';
        ...
        echo '</select>';
            ...
            if(isset($field->values) && count($field->values) > 0){
               ...
               foreach($field->values as $checkbox){
                  echo '<div class="checkbox'.(isset($field->inline) && $field->inline == 'true' ? ' checkbox-inline' : '').'">';
